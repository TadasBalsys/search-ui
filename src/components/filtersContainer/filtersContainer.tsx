...
import {
  ...
  color,
  getYearsArray,
  getEngineVolumeArray,
  engineVolume,
  getEnginePowerArray,
  enginePower,
} from '../../store/filtersList';
...
const FiltersContainer = () => {
  return (
    <div className={classes.MainContainer}>
      ...
      <div>
        <ul>
          <h5 className={classes.FilterTitle}>
            {steering_Wheel_Position.title}
          </h5>
          <OptionsContainer
            data={steering_Wheel_Position}
            key={steering_Wheel_Position.id}
          />
        </ul>
      </div>
      <div>
      ...
      <OptionsContainerSelect
        optionsArray={getYearsArray()}
        initOptionLabel={'Nuo'}
      />{' '}
      <OptionsContainerSelect
        optionsArray={getYearsArray()}
      ...
      <OptionsContainerSelect
        optionsArray={getEngineVolumeArray()}
        initOptionLabel={'Nuo'}
      />{' '}
      <OptionsContainerSelect
        optionsArray={getEngineVolumeArray()}
      ...
      <OptionsContainerSelect
        optionsArray={getEnginePowerArray()}
        initOptionLabel={'Nuo'}
      />{' '}
      <br />{' '}
      <OptionsContainerSelect
